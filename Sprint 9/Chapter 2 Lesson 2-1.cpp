...
vector<Spending> LoadFromJson(istream& input) {
    ...
    Document documents = Load(input);
    for (auto& document : documents.GetRoot().AsArray()) {
        string category = document.AsMap().at("category").AsString();
        int amount = document.AsMap().at("amount").AsInt();
